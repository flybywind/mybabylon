...
class App {
    constructor() {
        ...
        //>>> code starts here:
        var camera: BABYLON.ArcRotateCamera = new BABYLON.ArcRotateCamera("Camera",
            -Math.PI / 2, Math.PI / 2.5, 50, Vector3.Zero(), scene);
        camera.attachControl(canvas, true);
        var light1: BABYLON.HemisphericLight = new BABYLON.HemisphericLight("light1", new Vector3(1, 1, 0), scene);
        BABYLON.SceneLoader.ImportMeshAsync("him", "assets/scenes/Dude/", "Dude.babylon", scene).then((result) => {
